  ...
  function x() {
    ...
    var q,
      ...
      var d = a.match(/@media[^\{]+\{([^\{\}]*\{[^\}\{]*\})+/gi),
        ...
        var k, l, m, n;i ? (k = c, f.push(h(a))) : (k = d[j].match(/@media *([^\{]+)\{([\S\s]+?)$/) && RegExp.$1, f.push(RegExp.$2 && h(RegExp.$2))), m = k.split(","), n = m.length;for (var o = 0; n > o; o++) {
      ...
      var h = "clientWidth",
          ...
          n = {},
          o = l[l.length - 1],
          p = new Date().getTime();if (b && q && i > p - q) return a.clearTimeout(r), r = a.setTimeout(u, i), void 0;q = p;for (var v in e) {
